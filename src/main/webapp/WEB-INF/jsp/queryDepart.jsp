	...
	<div class="main-container">
		...
		<div class="main-content">
			...
			<div class="container">
				...
				<!-- end: PAGE HEADER -->
				<form role="form" class="form-horizontal" action="manage/queryDepartByName.do" method="post">
					<div class="row">
						...
						<div class="form-group col-sm-5" style="text-align:center;">
							...
							<a class="btn btn-primary" href="manage/toAddDepart.do"><i class="fa fa-plus"></i>
											添加部门</a>
						</div>
					</div>
				</form>
						...
						<table class="table table-hover" id="sample-table-1">
							...
							<c:forEach items="${departList }" var="depart">
								...
								<tr>
									...
									<td class="hidden-xs">${depart.name }</td>
									<td class="hidden-xs">${depart.parent.name }</td>

									<td class="hidden-xs">${depart.leader.name }</td>
									
									<td class="center">
									<!-- class="btn btn-xs btn-bricky" -->
										<div class="visible-md visible-lg hidden-sm hidden-xs">
												<c:if test="${parentId < 5 }">
													<a  href="manage/toAddSubDepart.do?pId=${depart.id }&parentId=${depart.parentId}"><i class="clip-add"></i>添加子部门
													</a>
													<a  href="manage/queryDepartByParentId.do?pId=${depart.id }"><i class="fa fa-sitemap"></i>查看子部门
													</a>
												</c:if>
												<a  href="manage/toUpdateDepart.do?departId=${depart.id }"><i class="fa fa-edit"></i>编辑
												</a>
												<a  href="manage/deleteDepart.do?departId=${depart.id }"><i class="fa fa-trash-o"></i>
												删除</a>
