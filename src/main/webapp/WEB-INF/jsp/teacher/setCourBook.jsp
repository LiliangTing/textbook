...
<body>
				...
				<span class="form-horizontal">
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
							课程名称 </label>
						<div class="col-sm-4">
							<input type="text" disabled="disabled" id="form-field-1"
								class="form-control" name="name" value="${cs.courses.name}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
						...
						<div class="col-sm-4">
							<input type="text" disabled="disabled" id="form-field-1"
								class="form-control" name="name" value="${cs.semester.name}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
							教材ISBN </label>
						<div class="col-sm-3">
							<input id="isbn" type="text" id="form-field-1"
								class="form-control" name="isbn" value="">
						</div>
						<div class="col-sm-1">
							<button type="button" class="btn btn-default"
								onclick="findBook()">查找</button>
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
							教材名称 </label> <span class="col-sm-4 " id="title"> </span>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
							出版社</label> <span class="col-sm-4 " id="publisher"> </span>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
							定价 </label> <span class="col-sm-4 " id="price"> </span>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
							简介 </label> <span class="col-sm-8 " id="summary"></span>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<div class="col-sm-6">
								<button type="button" onclick="submit()"
									class="btn btn-blue btn-block">确认</button>
							</div>
							<div class="col-sm-6">
	...
	<script>
		...
		function findBook() {
			...
			var uri = "https://api.douban.com/v2/book/isbn/" + isbn;
			$
					.ajax({
						url : uri,
						type : "get",
						...
						success : function(result) {
							...
							document.getElementById("summary").innerHTML = book.summary;
						},
						error : function() {
		...
		function submit() {
			var bookisbn = document.getElementById("isbn").value;
			var uri = "teacher/setCourBook/" + '${cs.id}' + "/" + bookisbn;
			$.ajax({
				url : uri,
				type : "post",
				success : function(result) {
