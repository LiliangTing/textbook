		...
		<div class="main-content">
			<div class="container">
				...
				<form role="form" class="form-horizontal"
					action="manage/updateDepart.do" method="post">
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
							部门名称 </label>
						<div class="col-sm-4">
							<input type="hidden" name="id" value="${depart.id }"> <input
								type="text" placeholder="部门名称" id="form-field-1"
								class="form-control" name="name" value="${depart.name}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select name="parentId" class="form-control search-select">
								<option value="0">无</option>
								<c:forEach items="${departList }" var="d">
									<c:choose>
										<c:when test="${d.id eq depart.parentId}">
						...
						<div class="col-sm-4">
							<select name="leaderId" class="form-control search-select"
								...
								<c:forEach items="${employeeList }" var="e">
									<c:choose>
										<c:when test="${e.id eq depart.leaderId}">
