													...
													<div class="center">
														...
														<div class="fileupload fileupload-new" data-provides="fileupload">
															<div class="user-image">
																<div class="fileupload-new thumbnail"><img src="${sessionScope.user.photoPath }" alt="">
																</div>
												...
												<div class="user-right">
													...
													<table class="table table-condensed table-hover">
														...
														<tbody>
															<tr>
																<td>职工工号:</td>
																<td>${sessionScope.user.eno }</td>
																<td><a href="#panel_edit_account" class="show-tab"><i class="fa fa-pencil edit-user-info"></i></a></td>
															</tr>
															<tr>
																<td>所在部门:</td>
																<td>${sessionScope.user.depart.name }</td>
																<td><a href="#panel_edit_account" class="show-tab"><i class="fa fa-pencil edit-user-info"></i></a></td>
															</tr>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="hidden" value="${sessionScope.user.id }" class="form-control"  name="id">
													...
													<div class="form-group">
														...
														<input type="email" value="${sessionScope.user.email }" class="form-control" id="email" name="email">
													</div>
													<div class="form-group">
														<label class="control-label">
															移动电话
														</label>
														<input type="tel" value="${sessionScope.user.phone }" class="form-control" id="phone" name="phone">
													</div>
													<div class="form-group">
														<label class="control-label">
															办公电话
														</label>
														<input type="tel" value="${sessionScope.user.tel }" class="form-control" id="tel" name="tel">
													</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" value="${sessionScope.user.name }" class="form-control" id="lastname" name="name">
													</div>
													<div class="form-group">
														<label class="control-label">
															职工性别
