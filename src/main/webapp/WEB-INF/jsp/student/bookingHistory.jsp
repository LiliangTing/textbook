	...
	<div class="main-container">
						...
						<table class="table table-striped table-bordered table-hover"
							...
							<thead>
								<tr>
									...
									<th class="center">状态</tr>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${list}" var="booking">
									<tr>
										<td class="center">${booking.sem.name}</td>
		...
		<c:if test="${booking.status == 1 }">
											<td class="center"><span
												class="label label-sm label-info">待发放</span></td>
										</c:if>
