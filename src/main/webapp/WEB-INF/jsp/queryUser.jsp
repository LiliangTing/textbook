			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<ol class="breadcrumb">
							<li><i class="clip-home-3"></i> <a href="manage/departIndex">
									首页 </a></li>
							<li>员工管理</li>
						...
						<table class="table table-hover" id="sample-table-1">
							...
							<tbody>
								<c:forEach items="${employeeList }" var="employee">
									...
									<tr>
										<%--<td ><img src="${ employee.photoPath}" alt="照片缩略图"
									...
									--%>
										...
										<td class="hidden-xs">${employee.depart.name }</td>
										<td>${employee.phone }</td>

										<td>${employee.tel}</td>
										<td>${employee.email }</td>
										<td><c:choose>
												<c:when test="${employee.role eq 0 }">
													<span class="label label-sm label-success">普通职工</span>
												</c:when>
												<c:when test="${employee.role eq 1 }">
													<span class="label label-sm label-danger">设备负责人</span>
												</c:when>
												<c:when test="${employee.role eq 2 }">
													<span class="label label-sm label-warning">部门负责人</span>
												</c:when>
												<c:otherwise>
													<span class="label label-sm label-inverse">国资处管理员</span>
												</c:otherwise>
											</c:choose></td>
										<td class="center">
											...
											<div class="visible-md visible-lg hidden-sm hidden-xs">
												...
												<a href="manage/toUpdateEmployee.do?eno=${employee.eno }"><i
													class="fa fa-edit"></i>编辑 </a> <a
													href="manage/deleteEmployee.do?eno=${employee.eno }"><i
