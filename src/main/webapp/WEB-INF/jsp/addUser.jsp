	...
	<div class="main-container">
		...
		<div class="main-content">
			<div class="container">
				...
				<form role="form" class="form-horizontal" action="manage/addEmployee.do"  method="post">
				<div class="form-group">
					...
					--%><div class="form-group">
						...
						<div class="col-sm-4">
							<div class="col-sm-6">
								<input type="submit" value="添加员工" class="btn btn-blue btn-block">
							</div>
							<div class="col-sm-6">
