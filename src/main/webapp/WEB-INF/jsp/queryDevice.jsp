...
function isOrder(did){
	...
	PostJSONQuery("manage/appOrder.do?did="+did,{},function(response){
	...
	--%><div class="main-container">
		...
		<div class="main-content">
			...
			<div class="container">
				...
				<!-- end: PAGE HEADER -->
				<form id="condition" role="form" class="form-horizontal" action="manage/queryDevice.do" method="post">
					<div class="row">
							...
							<div class="input-group col-sm-9">
								...
								<select name="receiverId" class="form-control search-select" id="form-field-3">
									...
									<c:forEach items="${employeeList }" var="employee">
										<c:choose>
											<c:when test="${employee.id eq receiverId}">
						...
						<table class="table table-hover" id="sample-table-1">
							<thead>
								<tr>
									...
									<th class="center">存放地点</th>
									<th class="center">领用人</th>
									<%--<th>领用人</th>
									--%>
							...
							<c:forEach items="${deviceList }" var="device">
								...
								<tr>
									...
									<td  class="center" width="10%">${device.name }</td>
									<td class="center" width="8%">${device.singlePrice }</td>
									<td class="center" width="8%">${device.totlePrice }</td>
									<td class="center" >${device.storageSite }</td>
									<td class="center" width="11%">${device.receiver.name }</td>
									
									<td class="center" width="15%">${device.depart.name }</td>
									...
									<!-- class="btn btn-xs btn-bricky" -->
										<div class="visible-md visible-lg hidden-sm hidden-xs">
											...
											<a onclick ="isOrder(${device.id });"><i class="fa fa-trash-o"></i>
												预约
											</a>
										</div></td>
